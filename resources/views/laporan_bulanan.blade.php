...
<div class="row" style="width:100%;display:flex">
    ...
    <div style="margin-left:700px">
        <p style="font-size:10px;margin:1px">LAPORAN BULANAN KEGIATAN OPERASIONAL DI PELABUHAN</p>
        <p style="font-size:10px;text-transform:uppercase;margin:1px">YANG TIDAK DIUSAHAKAN SECARA KOMERSIAL</p>
        <p style="font-size:10px;margin:1px;text-transform:uppercase;">BULAN : <?php echo $bulan_tahun?></p>
    </div>
</div>
            ...
            <?php
                foreach ($details as $key => $data) { ?>
                    <tr>
                        ...
                        <td><?php echo $data->grt ?></td></td>
                        <td><?php echo $data->dwt ?></td></td>
