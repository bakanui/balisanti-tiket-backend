...
//        Route::post('login', 'AuthManualController@login');
...
Route::group(['prefix' => 'rute'], function () {
    ...
    Route::group(['prefix' => 'jadwal_keberangkatan'], function () {
        ...
        // Route::post('proses/approval', [JadwalKeberangkatanController::class,'proses_approval'])->middleware('jwt.verify');
    ...
    Route::post('jadwal-by-easybook', [JadwalKeberangkatanController::class,'storeByEasyBook'])->middleware(['jwt.verify']);
    Route::get('jadwal-by-easybook', [JadwalKeberangkatanController::class,'getByEasyBook'])->middleware(['jwt.verify']);
